...
class Waitlist(Base):
    ...
    student_id = Column(Integer, ForeignKey("student.students.id", ondelete="CASCADE"), nullable=False)
    session_id = Column(Integer, ForeignKey("session.sessions.id", ondelete="CASCADE"), nullable=False)
